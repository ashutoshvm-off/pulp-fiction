  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 dark:text-white mb-6">Our Story</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Rooted in Nature</h2>
          ...
          <div className="flex gap-4">
            <div className="flex flex-col items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
              ...
              <span className="font-bold text-sm text-gray-800 dark:text-white">100% Organic</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
              <span className="material-symbols-outlined text-3xl text-primary mb-2">water_drop</span>
              <span className="font-bold text-sm text-gray-800 dark:text-white">Cold Pressed</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-xl">
              <span className="material-symbols-outlined text-3xl text-primary mb-2">recycling</span>
              <span className="font-bold text-sm text-gray-800 dark:text-white">Sustainable</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface-light dark:bg-surface-dark border border-primary/20 rounded-3xl p-8 md:p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Curated For You</h2>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {recommendedProducts.map(product => (
                <Link key={product.id} to={`/product/${product.id}`} className="bg-white dark:bg-black/20 rounded-xl p-4 hover:-translate-y-1 transition-transform duration-300 shadow-sm border border-transparent hover:border-primary/30">
                  <div className="aspect-square bg-gray-50 dark:bg-white/5 rounded-lg mb-4 p-4 flex items-center justify-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xs text-gray-500 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-full">Top Pick</span>
                  </div>
                </Link>
              ))}
            </div>
