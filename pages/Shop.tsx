...
export const Shop: React.FC = () => {
  ...
  // If categories are hidden or a category is selected, show products directly
  if (!showCategories || selectedCategory) {
    // ...existing code for product grid view...
    const currentCategory = categories.find(c => c.id === selectedCategory);

    return (
      <div>
        {/* Back Button & Category Header - only show if categories are enabled */}
        {showCategories && (
          <div className="mb-6">
            <button
        ...
        {/* Page Header when categories are hidden */}
        {!showCategories && (
          <div className="mb-6">
  ...
  // Show category cards when categories are enabled and no category selected
  return (
    <div>
      {/* Hero Banner Small */}
      <div className="relative w-full overflow-hidden rounded-2xl h-[150px] sm:h-[200px] mb-8 group">
        ...
        <div className="relative h-full flex flex-col justify-center px-4 sm:px-8 lg:px-16">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-black mb-1 sm:mb-2">Your Wellness Journey Begins</h1>
